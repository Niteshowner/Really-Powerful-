...
class TG_CONFIG:
    ...
    UPSTREAM_REPO = "https://github.com/aryanchy4499/hiw"
    UPSTREAM_BRANCH = "Aryan"
    bot_token = "7362696387:AAF7a6uTf4d2V7PtSSvRC22Fpk3WlHSu76c"
    owner_id = 7011929837
    #DEVS or #OWNERS
    sudo_users = [1596559467, -1002205027579, 7011929837, -1002233833025, 7011929837]
